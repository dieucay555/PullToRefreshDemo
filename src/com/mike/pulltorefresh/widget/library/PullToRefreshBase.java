...
import com.mike.pulltorefresh.widget.library.internal.FlipLoadingLayout;
import com.mike.pulltorefresh.widget.library.internal.LoadingLayout;
import com.mike.pulltorefresh.widget.library.internal.RotateLoadingLayout;
import com.mike.pulltorefresh.widget.library.internal.Utils;
import com.mike.pulltorefresh.widget.library.internal.ViewCompat;
		...
		switch (action) {
			case MotionEvent.ACTION_MOVE: {
				...
				if (isReadyForPull()) {
					 ...
					 * 2, check the move distance is far than touch_slop(if the distance is far than this, we think the user is moving)
					 * 3, check the diff is >0 or <0, we can separate two state (pull from start or pull from end)
					 * 4, if all support, change the mode
					 */
